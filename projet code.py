...
#caractéristiques des options du theme 4
    case_theme4_option1 = Checkbutton(window,text ='-Oui',bg='#048B9A',fg='black',font=("Courrier",15),activeforeground='white',activebackground='#048B9A',variable=oui_Oui_survivant)
    case_theme4_option2 = Checkbutton(window,text ='-Non',bg='#048B9A',fg='black',font=("Courrier",15),activeforeground='white',activebackground='#048B9A',variable=oui_Non_survivant)
...
#placement du bouton "rechercher"
    ...
    theme4_boutonsOui(oui_Oui_survivant,oui_Non_survivant)
    theme4_boutonsNon(oui_Oui_survivant,oui_Non_survivant)
