...
#caractéristiques des options du theme 1
    case_theme1_option1 = Radiobutton(window,text ='Homme',bg='#048B9A',\
                        ...
                        activebackground='#048B9A',variable=oui_homme,value=1)
    case_theme1_option2 = Radiobutton(window,text ='Femme',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',\
                        activebackground='#048B9A',variable=oui_homme,value=2)

#caractéristiques des options du theme 2

    case_theme2_option1 = Checkbutton(window,text ='1ère Classe',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',\
                        activebackground='#048B9A',variable=oui_1ere_classe)
    case_theme2_option2 = Checkbutton(window,text ='2ème Classe',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',
                        activebackground='#048B9A',variable=oui_2ere_classe)
    case_theme2_option3 = Checkbutton(window,text ='3ème Classe',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',\
                        activebackground='#048B9A',variable=oui_3ere_classe)

#caractéristiques des options du theme 3
    case_theme3_option1 = Checkbutton(window,text ='- de 18 ans',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',\
                        activebackground='#048B9A',variable=oui_moins_de_18)
    case_theme3_option2 = Checkbutton(window,text =' 18 à 50 ans',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',\
                        activebackground='#048B9A',variable=oui_de_18_a_50)
    case_theme3_option3 = Checkbutton(window,text =' plus de 50 ans',bg='#048B9A',\
                        fg='black',font=("Courrier",15),activeforeground='white',\
                        activebackground='#048B9A',variable=oui_plus_de_50ans)
...
#caractéristiques des options du theme 4
    case_theme4_option1 = Radiobutton(window,text ='Oui',bg='#048B9A',fg='black',\
                        ...
                        activebackground='#048B9A',variable=oui_Oui_survivant,value=1)
    case_theme4_option2 = Radiobutton(window,text ='Non',bg='#048B9A',fg='black',\
                        font=("Courrier",15),activeforeground='white',
                        activebackground='#048B9A',variable=oui_Oui_survivant,value=2)
